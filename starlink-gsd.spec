...
Ten pakiet zawiera bibliotekę dostępu do plików GSD (Global Section
Datafile - plików danych sekcji globalnej). Biblioteka umożliwia
dostęp tylko do odczytu do plików GSD tworzonych przez teleskop
James Clerk Maxwell Telescope.
...
Pliki nagłówkowe biblioteki GSD.
